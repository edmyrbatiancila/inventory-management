...
import { ArrowLeft, Asterisk, CheckCircle2, ClipboardList, Package, Save, WarehouseIcon } from "lucide-react";
...
const InventoryEdit = ({
    ...
    const { data, setData, put, processing, errors } = useForm({
        ...
        quantity_reserved: inventory.quantity_reserved?.toString() || '0',
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        put(route('admin.inventories.update', inventory.id), {
            onSuccess: () => {
            ...
            header={
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex flex-col justify-center">
                        <h2 className="text-2xl font-bold leading-tight text-gray-800">Edit Inventory</h2>
                        <p className="text-sm text-gray-600 mt-1">Update inventory information</p>
                    </div>
                </div>
            }
        >
